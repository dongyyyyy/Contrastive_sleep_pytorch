...
class ResNet_200hz(nn.Module):
    def __init__(self, block=BasicBlock, layers=[2,2,2,2], first_conv=[49, 4, 24],maxpool=[7,3,3], layer_filters=[64, 128, 256, 512], in_channel=1,num_classes=5,
                 block_kernel_size=3,block_stride_size=1,embedding=256,  use_batchnorm=False, zero_init_residual=False,
...
class ResNet_200hz_contrast(nn.Module):
    def __init__(self, block=BasicBlock, layers=[2,2,2,2], first_conv=[49, 4, 24],maxpool=[7,3,3], layer_filters=[64, 128, 256, 512], in_channel=1,num_classes=5,
                 block_kernel_size=3,block_stride_size=1,embedding=512,feature_dim=128,use_batchnorm=False, zero_init_residual=False,
                 groups=1, width_per_group=64, replace_stride_with_dilation=None,dilation=1,
                 norm_layer=None,dropout_p=0.):
        super().__init__()
        if norm_layer is None:
