...
def training_ResNet_dataAugmentation(blocks = Bottleneck,block_num = [3,4,6,3],block_channel = [64,128,128,256],first_conv = [49,10,24],block_kernel_size = 9,
    ...
    train_ResNet_dataAugmentation(save_filename=save_filename,logging_filename=logging_filename, train_dataset_list=training_fold_list,val_dataset_list=validation_fold_list,
